              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0" id="sort">
                    <thead>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Registration date</th>
                                    ...
                                    <tbody>
				  	<?php
                		$sql_emp = "select * from tbl_users where type='client' order by regdate desc";
				 ...
				 <tr>
					...
					<td data-table-header="Name" >
                        <h6 class="mb-0 text-sm"><?php echo $row_emp['name']; ?></h6>
                    </td>
					 
					<td data-table-header="Number" class="align-middle text-center text-sm">
						<h6 class="mb-0 text-sm"><?php echo $row_emp['number']; ?></h6>
                    </td>
                     
					<td data-table-header="Email ID" class="align-middle text-center">
                       <h6 class="mb-0 text-sm"><?php echo $row_emp['mailid']; ?></h6>
                    </td>
 
					<td data-table-header="Registration date" class="align-middle text-center">
						<h6 class="mb-0 text-sm"><?php echo $row_emp['regdate']; ?></h6>
                                           
					</td>
					<td data-table-header="status" class="align-middle text-center">
                    <?php 
                                        if($row_emp['status']==0)
                                        {
                    ?>
					...
					<td data-table-header="Action" class="align-middle">
                        <a href="clientupdate.php?aid=<?php echo $row_emp['id'];?>" class="todo-edit"><i class="fa fa-pencil" alt="edit" style="font-size:24px; color:deeppink;"></i></a>
						<a href="deleteclient.php?aid=<?php echo $row_emp['id'];?>" class="todo-remove" onclick="return checkDelete()">
