...
<?php
 ...
 $pro="SELECT * from tbl_users where id='".$_SESSION['id']."'";
 $cmd=mysqli_query($con,$pro);
 $pro_fetch=mysqli_fetch_array($cmd);
 if(!isset($_SESSION['id']))
  {
    header("location:index.php");
  }
  if(!($pro_fetch['type']=="client"))
  {
    header("location:../../index.php");
  } 
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="index.php" target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Best Cop Dashboard</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link  " href="../pages/im.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">IMEI Data</span>
          </a>
        </li>
		
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Insert Data</h6>
        </li>
      ...
      <a class="btn bg-gradient-primary mt-3 w-100" href="https://www.webcryptosolution.com/contact/">Contact Support</a>
    </div>
  </aside>
  ...
  { ?>
   ...
   <i class="fa fa-user me-sm-1"></i>
			<a href="index.php" class="nav-link text-body font-weight-bold px-0">             
			 <span class="d-sm-inline d-none">Sign In</span> </a>
